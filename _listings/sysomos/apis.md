...
name: Sysomos
x-slug: sysomos
description: A unified, insights-driven social platform empowering marketers to search,
  discover, listen, publish, engage, and analyze across earned, owned, and paid media.
...
- type: x-blog
  url: http://blog.sysomos.com
- type: x-blog-rss
  url: http://feeds2.feedburner.com/SysomosBlog
- type: x-crunchbase
  url: http://www.crunchbase.com/company/sysomos
- type: x-crunchbase
  url: https://crunchbase.com/organization/sysomos
- type: x-email
  url: salesupport@sysomos.com
- type: x-email
  url: privacy@sysomos.com
- type: x-twitter
  url: https://twitter.com/sysomos
include: []
maintainers:
- FN: Kin Lane
