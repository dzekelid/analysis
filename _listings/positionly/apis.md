...
name: Positionly
x-slug: positionly
description: Inbound Marketing Software by Positionly. Try the best user-friendly
  tools to track and improve SEO.
...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/positionly/apis.md
...
- name: Positionly
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/positionly/openapi.md
x-common:
- type: x-base
  url: https://api.positionly.com/
- type: x-blog
  url: http://blog.positionly.com/
- type: x-crunchbase
  url: https://crunchbase.com/organization/positionly
- type: x-crunchbase
  url: http://www.crunchbase.com/company/positionly
- type: x-developer
  url: https://positionly.com/api
- type: x-email
  url: reklamacje@positionly.com
- type: x-github
  url: https://github.com/positionly
- type: x-twitter
  url: https://twitter.com/UnamoHQ
- type: x-twitter
  url: https://twitter.com/positionly
- type: x-website
