...
created: "2018-02-24"
modified: "2018-02-24"
url: https://raw.githubusercontent.com/streamdata-gallery/analysis/master/_listings/azure-analysis-services/apis.yaml
...
- name: Azure Analysis Services API
  description: Use Azure Resource Manager to create and deploy an Azure Analysis Services
    ...
    and management benefits of the cloud
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/transform-complex-data.png
  humanURL: ""
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/analysis/master/_listings/azure-analysis-services/subscriptions-subscriptionid-providers-microsoft-analysisservices-servers-get.md
x-common:
