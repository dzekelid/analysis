...
description: Amazon Kinesis Analytics is the easiest way to process streaming data
  ...
  to your business and customer needs promptly.nAmazon Kinesis Analytics takes care
...
created: "2018-02-24"
modified: "2018-02-24"
url: https://raw.githubusercontent.com/streamdata-gallery/analysis/master/_listings/aws-kinesis-analytics/apis.yaml
...
- name: AWS Kinesis Analytics API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/analysis/master/_listings/aws-kinesis-analytics/action-updateapplication-get.md
x-common:
