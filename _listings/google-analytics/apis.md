...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/google-analytics/apis.md
...
- name: Google Analytics
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/google-analytics/openapi.md
x-common:
- type: x-api-gallery
  url: http://google.adsense.api.gallery.streamdata.io
- type: x-api-stack
  url: http://google.analytics.stack.network
- type: x-blog
