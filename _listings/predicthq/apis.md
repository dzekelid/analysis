...
- name: PredictHQ Retrieve Analysis
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/predicthq/v1signalssignal-idanalysis-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/predicthq/v1signalssignal-idanalysis-get-openapi.md
- name: PredictHQ
  x-api-slug: predicthq
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/analysis/master/_listings/predicthq/openapi.md
x-common:
- type: x-website
